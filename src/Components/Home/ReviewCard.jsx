    ...
    <>
      <div className="rounded-2xl">
        <div className="flex flex-col w-full gap-10 p-5 text-brand-whiteLight">
          ...
          {/* <div className="flex w-full gap-5 text-brand-black">
            <div className="flex w-full flex-col gap-5 bg-brand-whiteLight p-5 rounded-2xl">
              <img
                style={{ borderRadius: "50px", width: "70px", height: "70px" }}
                src="https://images.pexels.com/photos/4050350/pexels-photo-4050350.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              ></img>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Eligendi ratione dignissimos, nam aliquam sed voluptates nobis
                doloribus officiis et aperiam eos earum facere labore, obcaecati
                quidem cum nostrum facilis unde?
              </p>
            </div>
            <div className="flex w-full flex-col gap-5 bg-brand-whiteLight p-5 rounded-2xl">
              <img

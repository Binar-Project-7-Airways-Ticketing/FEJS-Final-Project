...
export default function CardResultBooking() {
  ...
  const [resultFlight, setResultFlight] = useState([])

  const navigate = useNavigate();

  const detailClassEconomy = (e) => {
    if (resultFlight.filter((item) => item.idFlight === e)) {
      setDetail(true);
      setEconomy(e);
    }
  };
  ...
  useEffect(()=> {
    ...
    setResultFlight(flight)
  },[resultFlight, resultFrom, resultTo])
      ...
      <div className="container">
        <div className="wrap-result-booking">
          <div className="text-brand-black 2xl:w-3/5 xl:w-3/4 mb-5">
            ...
            <h6>Result {resultFlight.length} Flight for you </h6>
          </div>
          <div className="flex flex-col gap-5">
            {resultFlight.map((item, i) => (
                    ...
                    <div className="result-booking">
                      <>
                        {detail ? (
                          <div
                            ...
                            onClick={() => detailClassClose(item.idPlaneClass)}
                          >
                      ...
                      <>
                        {detail ? (
                          ...
                          >
                            {item.plane.planeClass
                              .filter((item) => item.planeClass === "BUSINESS")
                              .map((item, i) => (
                                <h4 key={i}>{item.planeClass}</h4>
                              ))}
                            <div className="idr">
                    ...
                    <div className="flex flex-col p-5 bg-brand-whiteLight items-end rounded-lg w-full h-44 text-brand-black">
                      ...
                      <div className="times">
                        ...
                        <div className="time-logo">
                          <img className="xl:w-36 xl:h-36 lg:w-28 lg:h-28 w-24 h-24" src={logo}></img>
                        </div>
                        <div className="time">

...
export default function Transaction() {
  ...
  const [passanger1, setIsPasanger1] = useState(undefined);
  const [passanger2, setIsPassanger2] = useState(undefined);
    ...
    const Passanger1 = {
      "passenger": {
        "titleUser": "MR",
          ...
          "idCategory": 1,
            "nameCategory": "CHILDREN",
              "price": 0,
                "createdAt": "16-12-2022 01:12:14",
                  "updatedAt": "2022-12-16T13:23:14.390+00:00"
  ...
  setIsPasanger1(Passanger1);
  setIsPassanger2(Passanger2);
  
  dispatch(createPayment(passanger1));
  dispatch(createPayment(passanger2));
};
